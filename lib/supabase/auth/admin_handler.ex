defmodule Supabase.Auth.AdminHandler do
  @moduledoc false
  ...
  def sign_out(%Client{} = client, access_token, scope) do
    client
    |> Auth.Request.base(sign_out(scope))
    |> Request.with_body_decoder(Auth.Request.JSONDecoder)
  ...
  def generate_link(%Client{} = client, %{type: _, redirect_to: redirect_to} = params) do
    client
    |> Auth.Request.base(@generate_link)

defmodule Supabase.Auth.Admin do
  @moduledoc """
  Admin module for Auth. This module provides functions to interact with the Auth admin API,
  like signing out a user, inviting a user, and generating a link.

  You can find more information about the Auth admin API at https://supabase.io/docs/reference/javascript/auth-admin-api
  """

  @behaviour Supabase.Auth.AdminBehaviour

  alias Supabase.Auth.AdminHandler
  alias Supabase.Auth.Schemas.AdminUserParams
  alias Supabase.Auth.Schemas.GenerateLink
  alias Supabase.Auth.Schemas.InviteUserParams
  ...
  ## Examples
      ...
      iex> Supabase.Auth.Admin.sign_out(client, session, :global)
      :ok
  """
  @impl true
  ...
  ## Examples
      iex> Supabase.Auth.Admin.invite_user_by_email(client, "john@example.com", %{redirect_to: "https://example.com/welcome"})
  """
  @impl true
  ...
  * `{:ok, properties}` - Successfully generated link with properties:
  ...
  ## Examples
      ...
      iex> Supabase.Auth.Admin.generate_link(client, attrs)
  ...
  ## Examples
      ...
      iex> Supabase.Auth.Admin.create_user(client, attrs)
  ...
  ## Examples
      iex> Supabase.Auth.Admin.delete_user(client, "user_id")
      {:ok, %Supabase.Auth.User{}}
      
      # Soft delete a user
      iex> Supabase.Auth.Admin.delete_user(client, "user_id", should_soft_delete: true)
      {:ok, %Supabase.Auth.User{}}
  """
  @impl true
  ...
  ## Examples
      iex> Supabase.Auth.Admin.get_user_by_id(client, "d5bd2ef9-8df8-4e96-b592-35d120a8634c")
      {:ok, %Supabase.Auth.User{}}
  """
  @impl true
  ...
  ## Examples
      iex> Supabase.Auth.Admin.list_users(client, %{page: 1, per_page: 10})
      {:ok, [%Supabase.Auth.User{}, ...], %{next_page: 2, last_page: 5, total: 42}}
  """
  @impl true
  ...
  ## Examples
      ...
      iex> Supabase.Auth.Admin.update_user_by_id(client, "d5bd2ef9-8df8-4e96-b592-35d120a8634c", attrs)
      {:ok, %Supabase.Auth.User{}}
  """
  @impl true
  ...
  ## Examples
      iex> Supabase.Auth.Admin.delete_factor(client, "d5bd2ef9-8df8-4e96-b592-35d120a8634c", "totp-factor-id")
      :ok
  """
  @impl true
  ...
  ## Examples
      iex> Supabase.Auth.Admin.list_identities(client, "d5bd2ef9-8df8-4e96-b592-35d120a8634c")
      {:ok, [%Supabase.Auth.User.Identity{provider: :google, ...}, ...]}
  """
  @impl true
  ...
  ## Examples
      iex> Supabase.Auth.Admin.delete_identity(client, "d5bd2ef9-8df8-4e96-b592-35d120a8634c", "identity-id")
      :ok
  """
  @impl true
